...
def get_data():
    return [
        ...
        {
            "module_name": "Audit Accounting",
            "color": "#3498db",
            "icon": "octicon octicon-repo",
            "type": "module",
            "link": "modules/Audit Accounting",
            "label": _("Audit / Accounting"),
        },
        {
            "module_name": "Maintenance Setup",
            "color": "#FF888B",
            "icon": "octicon octicon-tools",
            "type": "module",
            "link": "modules/Maintenance Setup",
            "label": _("Maintenance and Setup"),
        },        
    ]
