...
frappe.ImportCustomer = Class.extend({
    init: function(parent) {
        
        this.page = frappe.ui.make_app_page({
            parent: parent,
            title: __("Upload Customer/Store List"),
            single_column: true
        });
        this.make();
        this.make_upload();
        ...
        //MARLO 20161027
        this.select.val('Customer').change();
    },
        ...
        this.select.on("change", function() {
            ...
            frappe.model.with_doctype(me.doctype, function() {
                ...
                if(me.doctype) {
                    ...
                    var required_fields = ['create_store', 'customer_type', 'customer_group', 'store_code', 'customer_name', 'default_price_list', 'ppp_location_code'];
...
frappe.pages['import-customer'].on_page_load = function(wrapper) {
    frappe.import_customer = new frappe.ImportCustomer(wrapper);
}

frappe.pages['import-customer'].on_page_show = function(wrapper) {
    frappe.import_customer && frappe.import_customer.set_route_options();
}
