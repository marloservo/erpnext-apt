//MARLO 20161027
//
frappe.ImportItemSku = Class.extend({
    init: function(parent) {
        ...
        this.page = frappe.ui.make_app_page({
            ...
            title: __("Upload Items and SKUs"),
            single_column: true
        });
        //MARLO 20161027
        ...
        this.select.on("change", function() {
            ...
            frappe.model.with_doctype(me.doctype, function() {
                ...
                if(me.doctype) {
                    ...
                    var required_fields = ['item', 'consignee', 'sku_name', 'stock_uom', 'standard_rate', 'group_rate'];
...
frappe.pages['import-item-sku'].on_page_load = function(wrapper) {
    frappe.import_item_sku = new frappe.ImportItemSku(wrapper);
}

frappe.pages['import-item-sku'].on_page_show = function(wrapper) {
    frappe.import_item_sku && frappe.import_item_sku.set_route_options();
}
