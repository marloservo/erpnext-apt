...
if(workflow_fieldname){var value=doc[workflow_fieldname];if(value){var colour="";if(in_list(locals["Workflow State"],value)&&locals["Workflow State"][value].style){var colour={"Success":"green","Warning":"orange","Danger":"red","Primary":"blue",}[locals["Workflow State"][value].style];}
...
this.list_settings_updated_on=this.list_settings.updated_on;},make_no_result:function(){var new_button=frappe.boot.user.can_create.indexOf(this.doctype)!=-1?('<p><button class="btn btn-default btn-sm" \
